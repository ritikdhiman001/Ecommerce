...
function Register() {
    ...
    async function subBtn(e) {
        ...
        if (formData.firstName.trim() == "") {
            ...
            setErrors((prev) => ({ ...prev, password: "Password must be at least 6 characters and include uppercase, lowercase, number, and special character" }))
        } else {
            setErrors({});
    ...
    return (
        <AppLayout>
            <div className="w-100 rounded-lg  p-6 bg-white relative overflow-hidden">
