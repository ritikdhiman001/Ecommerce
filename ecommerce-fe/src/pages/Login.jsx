...
function Login() {
  ...
  return (
    <AppLayout isBannerVisible={false}>
      <div className="h-[100vh] flex items-center justify-center p-5 md:mt-0 mt-5">
        <div className="w-100 rounded-lg  p-6 bg-white dark:bg-zinc-900 overflow-hidden border-2 shadow-[0px_0px_100px_50px_rgba(8,_11,_14,_0.06)] ">
